...
//   6. Find the difference between Jupiter's **momentum** and Pluto's **momentum**. (To get momentum, you'll want the product of **velocity** and **mass**). 
  let jupMomentum = (system.jupiter.velocity) * (system.jupiter.mass)
  let pluMomentum = (system.pluto.velocity) * (system.pluto.mass)
  let difference = pluMomentum - jupMomentum
